...
import com.crazy.taolove.listener.ModifyUserInfoListener;
...
import com.crazy.taolove.net.request.UpdateUserInfoRequest;
import com.crazy.taolove.ui.widget.ClearEditText;
...
//		Uri imageUri=FileProvider.getUriForFile(this, "com.crazy.taolove.fileProvider", file);//通过FileProvider创建一个content类型的Uri
