...
import com.crazy.taolove.adapter.ChatEmoticonsAdapter;
import com.crazy.taolove.adapter.ChatEmoticonsAdapter.OnEmojiItemClickListener;
import com.crazy.taolove.adapter.ChatMessageAdapter;
import com.crazy.taolove.adapter.PagerGridAdapter;
...
import com.crazy.taolove.db.IMessageDaoManager;
import com.crazy.taolove.entity.ClientUser;
import com.crazy.taolove.entity.Conversation;
import com.crazy.taolove.entity.Emoticon;
import com.crazy.taolove.entity.IMessage;
import com.crazy.taolove.eventtype.SnackBarEvent;
import com.crazy.taolove.helper.IMChattingHelper;
import com.crazy.taolove.listener.FileProgressListener;
import com.crazy.taolove.listener.FileProgressListener.OnFileProgressChangedListener;
import com.crazy.taolove.listener.MessageCallbackListener;
import com.crazy.taolove.listener.MessageCallbackListener.OnMessageReportCallback;
import com.crazy.taolove.listener.MessageStatusReportListener;
import com.crazy.taolove.listener.MessageStatusReportListener.OnMessageStatusReport;
import com.crazy.taolove.manager.AppManager;
import com.crazy.taolove.manager.NotificationManager;
import com.crazy.taolove.ui.widget.WrapperLinearLayoutManager;
import com.crazy.taolove.utils.EmoticonUtil;
import com.crazy.taolove.utils.FileAccessorUtils;
import com.crazy.taolove.utils.FileUtils;
import com.crazy.taolove.utils.ImageUtil;
		...
		if (intent.resolveActivity(getPackageManager())!=null){
			...
			if (mPhotoFile != null) {
				...
				mPhotoOnSDCardUri = FileProvider.getUriForFile(this,
						"com.crazy.taolove.fileProvider",
						mPhotoFile);
