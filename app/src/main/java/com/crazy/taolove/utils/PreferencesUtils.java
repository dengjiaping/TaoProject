...
public class PreferencesUtils {
	...
	/** 保存登陆账号 */
	public static final String SETTINGS_RL_ACCOUNT = "com.crazy.taolove_account";
	/** 保存登陆密码 */
	public static final String SETTINGS_RL_PASSWORD = "com.crazy.taolove_p";
	/** 保存是否第一次启动 */
	public static final String SETTINGS_RL_FIRST_LAUNCHER = "com.crazy.taolove_first_launcher";
	/** 用户年龄 */
	public static final String SETTINGS_RL_USER_AGE = "com.crazy.taolove_age";
	/** 头像url */
	public static final String SETTINGS_RL_USER_FACE_URL = "com.crazy.taolove_face_url";
	/** 手机号 */
	public static final String SETTINGS_RL_USER_MOBILE = "com.crazy.taolove_mobile";
	/** 个性签名 */
	public static final String SETTINGS_RL_USER_SIGNATURE = "com.crazy.taolove_signature";
	/** 保存用户性别 */
	public static final String SETTINGS_RL_USER_SEX = "com.crazy.taolove_sex";
	/** 用户名 */
	public static final String SETTINGS_RL_USER_USER_NAME = "com.crazy.taolove_user_name";
	/** 某用户是否第一次登录 */
	public static final String SETTINGS_RL_FIRST_LOGIN = "com.crazy.taolove_first_login";
	/** 是否登录 */
	public static final String SETTINGS_RL_IS_LOGIN = "com.crazy.taolove_is_login";
	/** 本地头像地址 */
	public static final String SETTINGS_RL_FACE_LOCAL = "com.crazy.taolove_face_local";
	/**sessionId */
	public static final String SETTINGS_RL_SESSIONID = "com.crazy.taolove_sessionid";
	/**qq号 */
	public static final String SETTINGS_RL_QQ = "com.crazy.taolove_qq";
	/**微信号 */
	public static final String SETTINGS_RL_WEIXIN = "com.crazy.taolove_weixin";
	/**身高 */
	public static final String SETTINGS_RL_TALL = "com.crazy.taolove_tall";
	/**体重 */
	public static final String SETTINGS_RL_WEIGHT = "com.crazy.taolove_weight";
	/**距离 */
	public static final String SETTINGS_RL_DISTANCE = "com.crazy.taolove_distance";
	/**情感状态 */
	public static final String SETTINGS_RL_EMOTION_STATUS = "com.crazy.taolove_emotion_status";
	/**星座 */
	public static final String SETTINGS_RL_CONSTELLATION = "com.crazy.taolove_constellation";
	/**城市 */
	public static final String SETTINGS_RL_CITY = "com.crazy.taolove_city";
	/**职业 */
	public static final String SETTINGS_RL_OCCUPATION = "com.crazy.taolove_occupation";
	/**教育 */
	public static final String SETTINGS_RL_EDUCATION = "com.crazy.taolove_education";
	/**交友目的 */
	public static final String SETTINGS_RL_PURPOSE = "com.crazy.taolove_purpose";
	/**爱爱地点 */
	public static final String SETTINGS_RL_LOVE_WHERE = "com.crazy.taolove_love_where";
	/**首次见面希望 */
	public static final String SETTINGS_RL_DO_WHAT_FIRST = "com.crazy.taolove_do_what_first";
	/**恋爱观念 */
	public static final String SETTINGS_RL_CONCEPTION = "com.crazy.taolove_conception";
	/**是否显示 */
	public static final String SETTINGS_RL_IS_SHOW = "com.crazy.taolove_is_show";
	/**是否vip */
	public static final String SETTINGS_RL_IS_VIP = "com.crazy.taolove_is_vip";
	/**isCheckPhone */
	public static final String SETTINGS_RL_IS_CHECK_PHONE = "com.crazy.taolove_is_check_phone";
	/**publicSocialNumber */
	public static final String SETTINGS_RL_PUBLIC_SOCIALNUMBER = "com.crazy.taolove_public_socialnumber";
	/** 新消息提醒 */
	public static final String SETTINGS_RL_NEW_MESSAGE_NOTICE = "com.crazy.taolove_new_message_notice";
	/** 通知显示消息详情 */
	public static final String SETTINGS_RL_NOTICE_MESSAGE_INFO = "com.crazy.taolove_notice_message_info";
	/** 通知声音*/
	public static final String SETTINGS_RL_NOTICE_VOICE = "com.crazy.taolove_notice_voice";
	/** 通知震动*/
	public static final String SETTINGS_RL_NOTICE_SHOCK = "com.crazy.taolove_notice_shock";
	/** 听筒播放*/
	public static final String SETTINGS_RL_EARPIECE_PLAY_VOICE = "com.crazy.taolove_earpiece_play_voice";
	/** 极光推送设置别名是否成功*/
	public static final String SETTINGS_JPUSH_SET_ALIAS = "com.crazy.taolove_jpush_set_alias";
	/** 抽奖次数*/
	public static final String SETTINGS_REWARD_COUNT = "com.crazy.taolove_reward_count";
	/** 定位到的城市*/
	public static final String SETTINGS_CURRENT_CITY = "com.crazy.taolove_current_city";
	/** 最近喜欢我的userid*/
	public static final String SETTINGS_LOVE_ME_USER_ID = "com.crazy.taolove_love_me_user_id";
	/** 最近关注我的userid*/
	public static final String SETTINGS_ATTENTION_ME_USER_ID = "com.crazy.taolove_attention_me_user_id";
	/** 最近送我礼物的userid*/
	public static final String SETTINGS_GIFT_ME_USER_ID = "com.crazy.taolove_gift_me_user_id";
	/** 登录时间*/
	public static final String SETTINGS_LOGIN_TIME = "com.crazy.taolove_login_time";
	/** 我的零钱*/
	public static final String SETTINGS_MY_MONEY = "com.crazy.taolove_my_money";
	/** 聊天次数限制*/
	public static final String SETTINGS_CHAT_LIMIT = "com.crazy.taolove_chat_limit";
